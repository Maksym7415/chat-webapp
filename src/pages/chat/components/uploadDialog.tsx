...
export default function UploadDialog({
  ...
  //     setSrc((prev: any) => ({
  //       ...prev,
  //       [name]: { file: reader.result, type: "image" },
  //     }));
  //   };
  ...
  //         return readImage(files[key], key);
  //       setSrc((prev: any) => ({
  //         ...prev,
  //         [key]: { file: files[key].name, type: "file" },
  //       }));
  //     });
  //   }
  // }, [files]);
  ...
  return (
    ...
    //           </div>
    //         ) : (
    //           <Paper className={classes.paperFileContainerDialog} key={hash}>
    //             <InsertDriveFileIcon />
    //             <p>{file.file}</p>
